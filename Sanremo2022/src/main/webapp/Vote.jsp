...
<% 
	...
	String language_vote = (String)(session.getAttribute("language"));
	String country_vote = (String)(session.getAttribute("country"));
	
	HashMap<String, String> speak_vote = new HashMap<String, String>();
	
	speak_vote.put("italian", "Vota il tuo cantante preferito!");
	speak_vote.put("english", "Vote your favorite singer!");
	speak_vote.put("it","Esprimi il tuo giudizio su ");
	speak_vote.put("eng","Express your opinion on ");
	
	String lang_vote="";
	String voto_vote="";
	
	if(country_vote.equals("IT")){
		lang_vote="italian";
		voto_vote="it";
	} else if(country_vote.equals("US")){
		lang_vote="english";
		voto_vote="eng";
	}
...
<h1 class="pt-3"><%=speak_vote.get(lang_vote) %></h1>
</div>

	<div class="container text-dark ">


	<div class="card mt-5 card-style" style="width: 20rem;">
    <img src="<%=second_arraylist.get(Integer.parseInt(richiesta)).getImmagine() %>" class="card-img-top" height="250px"alt="image">
	<div class="card-body">
	<h5 class="card-title text-center"><%=sessione[Integer.parseInt(richiesta)] %></h5>
	<p class="card-text"><%=speak_vote.get(voto_vote) + sessione[Integer.parseInt(richiesta)] %></p>
