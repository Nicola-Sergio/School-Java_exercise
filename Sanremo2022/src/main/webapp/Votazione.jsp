...
<% 
String richiesta = (String)request.getParameter("object");
...
<div class="row ">
<%
	out.println("<div class=\"col-sm-6 ml-5\">");
	out.println("<div class=\"card m-2\" style=\"width: 20rem;\">");
	  ...
	  out.println("<div class=\"card-body\">");
	    out.println("<h5 class=\"card-title\">"+sessione[Integer.parseInt(richiesta)] +"</h5>");
...
<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-hand-thumbs-down-fill" viewBox="0 0 16 16">
